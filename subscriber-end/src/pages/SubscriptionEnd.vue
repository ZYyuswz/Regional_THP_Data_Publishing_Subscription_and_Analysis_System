  ...
  <div class="page">
    <div class="page__header">
      <div>
        ...
        <h2>实时订阅与可视化</h2>
        <p class="desc">订阅温度 / 湿度 / 气压数据，查看表格与折线图预测。建议先订阅再发布。</p>
      </div>
      <div class="header__actions">
        <el-button class="outline-btn" plain @click="router.push('/home')">返回首页</el-button>
        <el-button class="outline-btn" plain @click="router.push('/pub')">前往发布端</el-button>
      </div>
    </div>
    ...
    <el-card shadow="hover" class="card">
      ...
      <div class="action-row">
        <el-button size="large" class="outline-btn" plain @click="toggleSubscription('temperature')">
          {{ isSubscribedToTemperature ? '取消订阅温度数据' : '订阅温度数据' }}
        </el-button>
        <el-button size="large" class="outline-btn" plain @click="toggleSubscription('humidity')">
          {{ isSubscribedToHumidity ? '取消订阅湿度数据' : '订阅湿度数据' }}
        </el-button>
        <el-button size="large" class="outline-btn" plain @click="toggleSubscription('pressure')">
